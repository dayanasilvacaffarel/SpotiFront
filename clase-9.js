...
window.setTimeout(function(){
    ...
    let conocerMusica = confirm("¿Desea conocer mas música?");
    let agregarParrafo = document.querySelector(".perfil");

    if(conocerMusica==true){
        window.location.href="https://open.spotify.com/";
    } else{
        agregarParrafo.innerHTML +=`
        
        <p style="color:green"> "Usuario oficial de Spotifront" </p>
        `
